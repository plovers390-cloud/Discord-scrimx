...
from models import Scrim, Tourney, Guild, EasyTag, TagCheck, BanLog, SSVerify, SSData
from utils import QuoRole, QuoTextChannel, checks, truncate_string
...
class ScrimManager(Cog, name="Esports"):
    ...
    async def tourney(self, ctx: Context):
        """Create & Manage tournaments with ScrimX"""
