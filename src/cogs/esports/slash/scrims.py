    ...
    async def parse_datetime(self, interaction: discord.Interaction, time: str) -> datetime:
        try:
            ...
            await interaction.followup.send(
                embed=discord.Embed(
                    color=discord.Color.red(), description=f"Invalid time format. Please try 24h time format."
                ).set_image(url="https://cdn.discordapp.com/attachments/1431705589251051722/1431854907085819924/Untitled_video_-_Made_with_Clipchamp.gif?ex=68feee4c&is=68fd9ccc&hm=8538863dd3bd7f2dfe664f8c5cf62c40b98132516a577a6a3b6164f94bad6ff6&")
            )
