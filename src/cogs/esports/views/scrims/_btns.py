    ...
    async def callback(self, interaction: Interaction):
        ...
        if not await self.ctx.is_premium_guild():
            return await self.ctx.error(
                "**ScrimX Premium is required to use this feature.**\n\n`Contact Bot Owner to activate Premium.`", 5
            )
...
class DuplicateTags(ScrimsButton):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if not await self.ctx.is_premium_guild():
            return await self.ctx.error(
                "[ScrimX Premium](https://discord.gg/QyhbVffzke) is required to use this feature.", 4
            )
...
class OpenTime(ScrimsButton):
    ...
    async def callback(self, interaction: Interaction):
        ...
        m = await self.ctx.simple(
            ...
            image="https://cdn.discordapp.com/attachments/1431849353433055372/1431850570741714965/Untitled_video_-_Made_with_Clipchamp.gif?ex=68feea42&is=68fd98c2&hm=c353bce2e3ed73afd8e505f2af4b0e99f35cc7cc77735b02624af6b500bed29c&",
...
class SetEmojis(ScrimsButton):
    ...
    async def callback(self, interaction: Interaction):
        ...
        e.set_image(url="https://cdn.discordapp.com/attachments/1431849353433055372/1431852233896628406/image.png?ex=68feebcf&is=68fd9a4f&hm=0afc713dbc1458c5821bb1bf304b65ec6ed6059b4f0a026da4d8985b6d329a6c&")
