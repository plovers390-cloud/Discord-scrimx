...
class TourneyGroupManager(EsportsBaseView):
    ...
    async def create_roles_channels(self, interaction: discord.Interaction, button: discord.Button):
        ...
        _e.set_image(url="https://cdn.discordapp.com/attachments/1431705589251051722/1431855505524920454/image.png?ex=68feeedb&is=68fd9d5b&hm=787c5af43ae28177cbf556db32ab67df0a304ace562b6188310d6f6d806d54ad&")
        ...
        _e.set_image(url="https://cdn.discordapp.com/attachments/1431705589251051722/1431855985982439544/Gemini_Generated_Image_i62p1ui62p1ui62p.png?ex=68feef4d&is=68fd9dcd&hm=f0ce5fd94a4adfac28ba5a1eef1839cb8dd549102ca2bd7e07245ddcbcef82b6&")
        m = await interaction.followup.send(embed=_e)
