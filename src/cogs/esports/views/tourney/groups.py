...
class GroupListView(EsportsBaseView):
    ...
    @discord.ui.button(custom_id="publish_g_hook", emoji="<a:diamantee:1431513679160938646>", label="Webhook (Recommended)")
    ...
    @discord.ui.button(custom_id="publish_g_bot", emoji="<:sky_punishment:1431635607544664155>", label="With Bot")
