...
class SetEmojis(TourneyButton):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if not await self.ctx.is_premium_guild():
            return await self.ctx.error(
                "[SxrimX Premium](https://discord.gg/QyhbVffzke) is required to use this feature.", 4
            )
        ...
        e.set_image(url="https://cdn.discordapp.com/attachments/1431705589251051722/1431856534480097392/image.png?ex=68feefd0&is=68fd9e50&hm=8e1d6a7095b6d98424623c8b9bd2804aa430e5f5ab3bde57efb1dea0059d52da&")
