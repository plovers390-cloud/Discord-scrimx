...
class SlotlistEditButton(discord.ui.View):
    ...
    async def ban_slot(self, interaction: discord.Interaction, button: discord.Button):
        ...
        if slot_ids := _v.custom_id:
            ...
            _e.set_image(url="https://cdn.discordapp.com/attachments/1431849353433055372/1431854565740777593/image.png?ex=68feedfb&is=68fd9c7b&hm=4ed1d124c80e6bdd0ec1f27c9e0155a27a3bc49c2867372163ce448dffefae15&")
