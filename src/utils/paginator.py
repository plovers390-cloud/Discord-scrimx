...
class PaginatorView(discord.ui.View):
    ...
    @discord.ui.button(style=discord.ButtonStyle.green, custom_id="first", emoji="<:blueskip2:1431654457728303207>")
    ...
    @discord.ui.button(style=discord.ButtonStyle.green, custom_id="previous", emoji="<:left:1431653078146482209>")
    ...
    @discord.ui.button(style=discord.ButtonStyle.green, custom_id="next", emoji="<:right:1431653218924105970>")
    ...
    @discord.ui.button(style=discord.ButtonStyle.green, custom_id="last", emoji="<:blueSkip:1431654415030292533>")
