...
class PremiumPlan(BaseDbModel):
    ...
    async def insert_plans():
        ...
        await PremiumPlan.create(
            name="Pro (3m)", description="Duration: 84 days", price=229, duration=timedelta(days=84)
        )
        await PremiumPlan.create(
            name="Prime (6m)", description="Duration: 168 days", price=469, duration=timedelta(days=168)
        )
        await PremiumPlan.create(
            name="Lifetime", description="Duration: 69 years", price=4999, duration=timedelta(days=25185)
        )
