...
class Nothing(commands.AutoShardedBot):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(
            ...
            activity=discord.Activity(
                ...
                name=f"xsetup | xhelp | {cfg.SERVER_LINK}"
            ),
    ...
    @property
    def prime_link(self):
        return "https://discord.gg/QyhbVffzke"
    ...
    def reboot(self):
        return os.system("pm2 reload ScrimX")
    ...
    # simple way to support mention + prefix
        return commands.when_mentioned_or(prefix, prefix.upper())(self, message)
