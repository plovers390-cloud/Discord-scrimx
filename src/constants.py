...
tips = (
    "We have an awesome support server:\ndiscord.gg/QyhbVffzke",
    "You can set custom reactions for tourneys & scrims with ScrimX Pro.",
    "I like your face : )",  # I really do
    "You can add a role to multiple users with `role @role @user @user2...` command.",
    "ScrimX can detect and verify youtube/insta/loco,etc. screenshots (`ssverify` cmd).",
    "You can buy ScrimX Pro for 29INR only at <https://discord.gg/QyhbVffzke>",
    ...
    "With ScrimX Pro you can set custom DM message.",
    "Do you know that Rohit was a very good bot developer who created the Quotient Bot?\n A part of his code still exists within me — modified by Trust.\n Even though Rohit is no longer among us, his code still lives on. Thank you, Rohit. ",
)
...
async def remind_premium(ctx):
    ...
    _e.description = (
        f"Your ScrimX Premium subscription is ending {discord_timestamp(guild.premium_end_time)}\n\n"
